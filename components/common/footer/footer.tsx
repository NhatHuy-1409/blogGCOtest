          ...
          <div className="w-full md:w-5/12">
            <div>
              ...
              <ul className="text-gray-300">
                ...
                <div className="flex">
                  <li className="mb-4 flex items-start flex-wrap w-1/2">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" className="h-6 w-1/5"><path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                    <div className="w-4/5">
                      <a href="#" className=" hover:underline ">
                        Điện thoại
                      </a>
                  ...
                  <li className="mb-4 flex items-start flex-wrap w-1/2">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" className="h-6 w-1/5"><path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                    <div className="w-4/5">
                      <a href="#" className=" hover:underline ">
                        Email
                      </a>
